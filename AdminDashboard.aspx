<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDashboard.aspx.cs" Inherits="VTourKitchener.AdminDashboard" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ul class="nav nav-pills" style="margin-top: 51px">
            ...
            <li class="clsAllUsers active"><a>Users</a></li>
        </ul>
        ...
        <script src="js/jAdminDashBoard.js"></script>
